...
export function initEvents (vm: Component) {
  ...
  // vm._events.__proto__.constructor === Object
  // vm._events.__proto__.__proto__ === null
  // 返回 {} 没有任何属性 没有原型链上乱七八糟的方法 显式指定NULL作为它的原型。所以它绝对没有属性，甚至没有构造函数、toString、hasOwnProperty属性
...
export function eventsMixin (Vue: Class<Component>) {
  ...
  Vue.prototype.$on = function (event: string | Array<string>, fn: Function): Component {
    ...
    // 链式写法, 返回当前实例, 方便后期调用 同 return this
    return vm
  }
